...
!function(t){function e(t){var e,a,d,i,r,o,h;void 0!==t.time&&""!=t.time||(t.time=(e=new Date,a=e.getFullYear(),d=n(e.getMonth()+1),i=n(e.getDate()),r=n(e.getHours()),o=n(e.getMinutes()),h=n(e.getSeconds()),a+"-"+d+"-"+i+" "+r+":"+o+":"+h));var u="";return u+="<div class='comment-section'>",u+="<h3>"+t.author+"</h3>",u+="<h5>"+t.time+"</h5>",u+="<p>"+t.content+"</p>",u+="</div>",u+="<hr />"}function n(t){return t<10?"0"+t:t}t.fn.addCommentList=function(n){var a=t.extend({data:[],add:""},n);if(""!=a.add){var d=e(h=a.add);t(this).append(d)}if(a.data.length>0){for(var i=a.data,r="",o=0;o<i.length;o++){var h=i[o];r+=e(h)}t(this).append(r)}}}(jQuery);
...
!function(e){e.fn.qqFace=function(t){var n=e.extend({id:"facebox",path:"face/",assign:"content",tip:"em_"},t),i=e("#"+n.assign),o=n.id,a=n.path,c=n.tip;if(i.length<=0)return alert("缺少表情赋值对象。"),!1;e(this).click(function(t){var i,s;if(e("#"+o).length<=0){i='<div id="'+o+'" style="position:absolute;display:none;z-index:1000;" class="qqFace"><table border="0" cellspacing="0" cellpadding="0"><tr>';for(var l=1;l<=75;l++)s="["+c+l+"]",i+='<td><img src="'+a+l+'.gif" onclick="$(\'#'+n.assign+"').setCaret();$('#"+n.assign+"').insertAtCaret('"+s+"');\" /></td>",l%15==0&&(i+="</tr><tr>");i+="</tr></table></div>"}e(this).parent().append(i);var r=e(this).position(),d=r.top+e(this).outerHeight();e("#"+o).css("top",d),e("#"+o).css("left",r.left),e("#"+o).show(),t.stopPropagation()}),e(document).click(function(){e("#"+o).hide(),e("#"+o).remove()})}}(jQuery),jQuery.extend({unselectContents:function(){window.getSelection?window.getSelection().removeAllRanges():document.selection&&document.selection.empty()}}),jQuery.fn.extend({selectContents:function(){$(this).each(function(e){var t,n,i,o;(i=this.ownerDocument)&&(o=i.defaultView)&&void 0!==o.getSelection&&void 0!==i.createRange&&(t=window.getSelection())&&void 0!==t.removeAllRanges?((n=i.createRange()).selectNode(this),0==e&&t.removeAllRanges(),t.addRange(n)):document.body&&void 0!==document.body.createTextRange&&(n=document.body.createTextRange())&&(n.moveToElementText(this),n.select())})},setCaret:function(){var e=function(){$(this).get(0).caretPos=document.selection.createRange().duplicate()};$(this).click(e).select(e).keyup(e)},insertAtCaret:function(e){var t=$(this).get(0);if(document.all&&t.createTextRange&&t.caretPos){var n=t.caretPos;n.text=""==n.text.charAt(n.text.length-1)?e+"":e}else if(t.setSelectionRange){var i=t.selectionStart,o=t.selectionEnd,a=t.value.substring(0,i),c=t.value.substring(o);t.value=a+e+c,t.focus();var s=e.length;t.setSelectionRange(i+s,i+s),t.blur()}else t.value+=e}});
