...
;(function($){
	function createCommentInfo(obj) {
		
		if (typeof(obj.time) == "undefined" || obj.time == "") {
			obj.time = getNowDateFormat();
		}
        /*
        if (typeof(obj.avatar) == "undefined" || obj.avatar == "") {
            obj.avatar = "/images/comment-avatar-default.jpg";
        }
        */
		
		var el = "";
        el += "<div class='comment-section'>";
        //el += "<header><img src='"+obj.avatar+"' /></header>";
        el += "<h3>"+obj.author+"</h3>";
        el += "<h5>"+obj.time+"</h5>";
        el += "<p>"+obj.content+"</p>";
		//el += "<button class='button blue reply-btn'>回复</span>";
        el += "</div>";
        el += "<hr />";
	...
	$.fn.addCommentList = function(options) {
		...
		if (option.data.length > 0) {
			...
			for (var i=0; i<dataList.length; i++) {
				var obj = dataList[i];
				var objString = createCommentInfo(obj);
